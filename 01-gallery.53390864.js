...
galleryRef.innerHTML = createGalleryMarkup((0, _galleryItems.galleryItems));
function createGalleryMarkup(arr) {
    return arr.reduce((acc, { preview , original , description  })=>acc + `<a class="gallery__item" href="${original}">
        <img
