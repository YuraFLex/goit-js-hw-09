...
var _convertMs = require("./convertMs");
var _convertMsDefault = parcelHelpers.interopDefault(_convertMs);
...
const fp = (0, _flatpickrDefault.default)(refs.inputDateTime, options);
let intervalId = null;
setAttrDisabled(refs.startBtn);
...
function timer(date) {
    ...
    const timeObj = (0, _convertMsDefault.default)(leftTime);
...
refs.fields.forEach((field)=>field.style = "display: flex; flex-direction: column; align-items: center");
refs.values.forEach((value)=>value.style.fontSize = "50px");
refs.labels.forEach((label)=>label.style = "text-transform: uppercase; font-size: 18px; font-weight: 500");

},{"flatpickr":"llQu5","flatpickr/dist/flatpickr.min.css":"eVN6V","notiflix/build/notiflix-notify-aio":"eXQLZ","./convertMs":"cx1rA","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"llQu5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"cx1rA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
